...
|------|----------|-------------|----------|
| **Tier 1** | CI 자동 (ArchUnit, 금지 import 검사) | 빌드 실패 — 즉시 수정 | D-1~D-4, A-1, AD-1~AD-2 |
| **Tier 2** | AI 자기검증 (PR 체크리스트) | AI가 자동 수정 후 재커밋 | D-5~D-14, A-2~A-11, AD-3~AD-7, T-1~T-3 |
| **Tier 3** | 코드 리뷰 (사람) | 리뷰어 지적 시 수정 | 네이밍 컨벤션, 설계 판단, Aggregate 크기 |
